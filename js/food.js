(() => {
  ...
  const PLACES = [
    ...
    },
    {
      ...
      img:'images/huslycafecatering.jpg',
    ...
    // ——— Bakeries / coffee ———
    {
      ...
      img:'images/aasmundsenbakeri.jpg',
      hours:null
    }
  ];
  ...
  const MORE_BARS = [
    ...
    },
    {
      ...
      img:'images/kultoreskroaibo.jpg',
  ...
  PLACES.push({
    ...
    img: 'images/artisanbakery.jpg', // or any photo you like
    hours: {
      0: [],                     // Sun
      1: [['10:00','16:00']],
      2: [['10:00','16:00']],
  ...
  const NEARBY_PLACES = [
    {
      ...
      img:'images/aarneskafeteria.jpg',
    ...
    },
    {
      ...
      img:'images/lindheimolkompani.jpg',
      // Seasonal; hours vary
      hours:null
    },
    {
